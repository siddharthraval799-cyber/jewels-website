...
const artisanImage = "https://www.rushabhjewel.com/_next/image?url=%2Fsiteassets%2Fimages%2Fbanner%2Frushabh-shah-2.png&w=3840&q=75";
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <motion.div
               ...
               className="w-full relative rounded-2xl overflow-hidden shadow-2xl mt-auto"
            >
               <img 
                 src={artisanImage}
