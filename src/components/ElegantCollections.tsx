        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {collections.map((item, idx) => (
            <motion.div
              ...
              className="group relative h-[3000px] md:h-[350px] rounded-2xl overflow-hidden shadow-md"
            >
